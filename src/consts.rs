...
pub const ANSUMAN_MODERATION_MODE: &str = "ANSUMAN_MODERATION_MODE";
pub const ANSUMAN_TIMEOUT_MS: &str = "ANSUMAN_TIMEOUT_MS";
...
pub const VIDEOGEN_UPLOAD_URL_PRE_SUBMIT_MARGIN_SECS: &str =
    "VIDEOGEN_UPLOAD_URL_PRE_SUBMIT_MARGIN_SECS";
pub const VIDEOGEN_VAST_IMAGE_STAGE_TIMEOUT_SECS: &str = "VIDEOGEN_VAST_IMAGE_STAGE_TIMEOUT_SECS";
pub const VIDEOGEN_CONTEXT_CREATED_TIMEOUT_SECS: &str = "VIDEOGEN_CONTEXT_CREATED_TIMEOUT_SECS";
pub const VIDEOGEN_LTX_GENERATION_TIMEOUT_SECS: &str = "VIDEOGEN_LTX_GENERATION_TIMEOUT_SECS";
pub const VIDEOGEN_COMPLETION_RETRY_GRACE_SECS: &str = "VIDEOGEN_COMPLETION_RETRY_GRACE_SECS";
pub const VIDEOGEN_VAST_UPLOAD_RETRY_WINDOW_SECS: &str = "VIDEOGEN_VAST_UPLOAD_RETRY_WINDOW_SECS";
pub const VIDEOGEN_VAST_UPLOAD_EXPIRY_REFRESH_MARGIN_SECS: &str =
    "VIDEOGEN_VAST_UPLOAD_EXPIRY_REFRESH_MARGIN_SECS";
pub const VIDEOGEN_UPLOAD_URL_SAFETY_BUFFER_SECS: &str = "VIDEOGEN_UPLOAD_URL_SAFETY_BUFFER_SECS";
pub const VIDEOGEN_UPLOAD_URL_TTL_SECS: &str = "VIDEOGEN_UPLOAD_URL_TTL_SECS";
pub const VIDEOGEN_RECONCILIATION_INTERVAL_SECS: &str = "VIDEOGEN_RECONCILIATION_INTERVAL_SECS";
pub const VIDEOGEN_RECONCILIATION_BATCH_SIZE: &str = "VIDEOGEN_RECONCILIATION_BATCH_SIZE";
pub const VIDEOGEN_DRAFT_CREATE_MAX_ATTEMPTS: &str = "VIDEOGEN_DRAFT_CREATE_MAX_ATTEMPTS";
pub const VIDEOGEN_DRAFT_CREATE_TIMEOUT_SECS: &str = "VIDEOGEN_DRAFT_CREATE_TIMEOUT_SECS";
pub const VIDEOGEN_DRAFT_CREATED_COMPLETE_TIMEOUT_SECS: &str =
    "VIDEOGEN_DRAFT_CREATED_COMPLETE_TIMEOUT_SECS";
pub const VIDEOGEN_DRAFT_RETRY_RETENTION_HOURS: &str = "VIDEOGEN_DRAFT_RETRY_RETENTION_HOURS";
...
pub const VIDEOGEN_COMPLETION_HMAC_KEY_RETENTION_HOURS: &str =
    "VIDEOGEN_COMPLETION_HMAC_KEY_RETENTION_HOURS";
